    ...
    return (
            <div className="flex flex-col gap-2  bg-zinc-100  text-slate-900 w-55 h-57 rounded-lg p-3.5">
                ...
                <div className="flex justify-between mt-auto">
                    ...
                    className="bg-red-400 text-blue-950 text-sm font-medium py-1 px-2 rounded w-22
                    ...
                    className="bg-green-400 text-blue-950 text-sm font-medium py-1 px-2 rounded w-22
