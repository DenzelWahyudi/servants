...
export function RegisterAdmin() {
    ...
    return(
        <div className="mx-auto px-4 sm:px-8 py-8 sm:py-12 flex flex-col gap-8 sm:gap-12 items-center min-h-screen">
                ...
                <div className="flex flex-col gap-4 p-6 sm:p-10 bg-slate-800/80 backdrop-blur-sm border border-slate-700/50 shadow-2xl items-center rounded-2xl w-full max-w-md">
                    ...
                    <div className="w-full mt-4 flex flex-col gap-6">
                        ...
                        <div className="flex items-center justify-center gap-2">
                            ...
                            <ButtonLink to='/admin/login' variant="secondary" className="text-amber-400 text-sm font-semibold hover:text-amber-300">Login</ButtonLink>
                        </div>
                    </div>
                </div>
            ) : (
